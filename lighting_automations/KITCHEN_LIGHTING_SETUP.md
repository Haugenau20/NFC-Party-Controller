...
Or check your existing playlist automations to find the tag UIDs you're already using.
...
# NFC Tag UIDs - Energetic Category (14 playlists)
...
# NFC Tag UIDs - Chill Category (4 playlists)
